                        ...
                        <>
                            <SheetHeader className="p-6 border-b">
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-lg border-2 flex items-center justify-center bg-accent/50">
                                        {selectedIcon.source === "lineicons" ? (
                                            ...
                                            <SelectedIconComponent size={32} strokeWidth={1.5} />
                                        ) : null}
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            <Badge variant="outline" className="capitalize">{selectedIcon.source}</Badge>
                                        </div>
                                    </div>
                                </div>
                            </SheetHeader>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => setExportSettings({ ...exportSettings, size: Number(e.target.value) })}
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => setExportSettings({ ...exportSettings, stroke: Number(e.target.value) })}
                                                step={0.5}
                                                min={0.5}
                                                max={3}
                                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => setExportSettings({ ...exportSettings, padding: Number(e.target.value) })}
                                                min={0}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-4 gap-2">
                                            {["SVG", "JSX", "PNG", "PDF"].map((type) => (
                                                <Button
                                                    key={type}
                                                    variant={exportSettings.fileType === type ? "default" : "outline"}
                                                    size="sm"
                                ...
                                {/* Preview Area */}
                                <div className="rounded-lg border bg-card p-8 flex items-center justify-center min-h-[200px]">
                                    {selectedIcon.source === "lineicons" ? (
                                        <div
                                            style={{
                                                padding: `${exportSettings.padding}px`,
                                                background: exportSettings.fileType === "PNG" ? "#ffffff" : "transparent"
                                            }}
                                        >
                                            <img
                                                src={getLineiconSvgPath(selectedIcon.name)}
